...
export class DataService {
  ...
  GetGoalStats(): Observable<any> {
    ...
    return this.http
      .get<Response>(
        this.apiUrl + 'v3/players/topscorers?league=140&season=2023',
        { headers }
      )
      .pipe(
        map((data) =>
          data.response.map((item) => ({
            ...
            name: item.player.firstname,
            lastname: item.player.lastname,
            team: item.statistics[0].team.logo,
  ...
  GetAsistStats(): Observable<any> {
    ...
    return this.http
      .get<Response>(
        this.apiUrl + 'v3/players/topassists?league=140&season=2023',
        { headers }
      )
      .pipe(
        map((data) =>
  ...
  GetYellowtStats(): Observable<any> {
    const headers = new HttpHeaders({
      'x-rapidapi-host': 'api-football-v1.p.rapidapi.com',
      'x-rapidapi-key': '9426b229d3msh2145ddb6ba8544ep16d0dcjsn72b357b522cf',
      // 'x-rapidapi-key': 'c088b8541fmshfa41ddf1da664e1p19b8cejsn22b5892d684a'
    ...
    return this.http
      .get<Response>(
        this.apiUrl + 'v3/players/topyellowcards?league=140&season=2023',
        { headers }
      )
      .pipe(
        map((data) =>
